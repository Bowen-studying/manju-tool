...
$archivePath = Join-Path ([System.IO.Path]::GetTempPath()) ("manju-m21-" + [guid]::NewGuid().ToString("N") + ".zip")
try {
    ...
    $overlay = @(
        ...
        "docs\PRODUCTION_RUN_M2_0_TESTING.md", "docs\PRODUCTION_RUN_M2_0_1_TESTING.md", "docs\PRODUCTION_RUN_M2_1_TESTING.md",
        "tools\package_production_run_m1.ps1", "tools\package_production_run_m2.ps1",
        "tools\package_production_run_m2_0_1.ps1", "tools\package_production_run_m2_1.ps1"
    )
