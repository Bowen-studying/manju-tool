...
$archivePath = Join-Path ([System.IO.Path]::GetTempPath()) ("manju-m26-" + [guid]::NewGuid().ToString("N") + ".zip")
try {
    ...
    foreach ($relativePath in @(
        ...
        "docs\PRODUCTION_RUN_M2_3_TESTING.md", "docs\PRODUCTION_RUN_M2_3_1_TESTING.md", "docs\PRODUCTION_RUN_M2_4_TESTING.md", "docs\PRODUCTION_RUN_M2_4_1_TESTING.md", "docs\PRODUCTION_RUN_M2_5_TESTING.md", "docs\PRODUCTION_RUN_M2_6_TESTING.md",
        "tools\package_production_run_m2_3.ps1", "tools\package_production_run_m2_3_1.ps1", "tools\package_production_run_m2_4.ps1", "tools\package_production_run_m2_6.ps1"
    )) {
