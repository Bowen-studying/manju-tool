...
$archivePath = Join-Path ([System.IO.Path]::GetTempPath()) ("manju-m211-" + [guid]::NewGuid().ToString("N") + ".zip")
try {
    ...
    $overlay = @(
        ...
        "tests\test_production_run.py", "tests\test_production_m2_contracts.py", "tests\test_production_m2_1_mock_visual.py",
        "docs\PRODUCTION_RUN_V1_ARCHITECTURE.md", "docs\PRODUCTION_RUN_M1_ACCEPTANCE.md",
        "docs\PRODUCTION_RUN_M1_1_TESTING.md", "docs\PRODUCTION_RUN_M2_CONTRACT.md",
        "docs\PRODUCTION_RUN_M2_0_TESTING.md", "docs\PRODUCTION_RUN_M2_0_1_TESTING.md",
        "docs\PRODUCTION_RUN_M2_1_TESTING.md", "docs\PRODUCTION_RUN_M2_1_1_TESTING.md",
        "tools\package_production_run_m1.ps1", "tools\package_production_run_m2.ps1",
        "tools\package_production_run_m2_0_1.ps1", "tools\package_production_run_m2_1.ps1", "tools\package_production_run_m2_1_1.ps1"
    )
