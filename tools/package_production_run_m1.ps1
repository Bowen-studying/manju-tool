...
$archivePath = Join-Path ([System.IO.Path]::GetTempPath()) ("manju-m1-" + [guid]::NewGuid().ToString("N") + ".zip")
try {
    ...
    $overlay = @(
        "README.md",
        "manju\\cli.py",
        "manju\\pipeline\\storyboard.py",
        "manju\\pipeline\\storyboard_supervisor.py",
        "tests\\test_production_run.py",
        "docs\\PRODUCTION_RUN_V1_ARCHITECTURE.md",
        "docs\\PRODUCTION_RUN_M1_ACCEPTANCE.md",
        "docs\\PRODUCTION_RUN_M1_1_TESTING.md",
        "tools\\package_production_run_m1.ps1"
    )
